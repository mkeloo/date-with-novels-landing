...
export default function HomeClient() {
    ...
    return (
        <div
            className="w-full flex flex-col min-h-screen bg-cover bg-center  items-center justify-center px-4 md:px-20 lg:px-40 py-10"
            style={{ backgroundImage: `url(${bgImage.src})`, viewTransitionName: "page", }}
        >
